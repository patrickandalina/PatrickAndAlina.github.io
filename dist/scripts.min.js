function init() {
    for (var myLatlng = new google.maps.LatLng(36.8764, -119.7774), mapOptions = {
            zoom: 9,
            center: myLatlng,
            scrollwheel: !1,
            styles: [{
        ...
        addresses = ["355 E Champlain Dr, Fresno, CA 93730", "4219 S Highland Ave, Del Rey, CA 93616"], 
        x = 0; x < addresses.length; x++) 
        ...
        if (data.results[0].formatted_address == "355 E Champlain Dr, Fresno, CA 93730, USA" )
        {        
            new google.maps.Marker({
            position: latlng,
            map: map,
            icon: "images/church_loc.png",
            title: "Holy Spirit Catholic Church",
            link: "https://www.google.com/maps/dir/''/holy+spirit+catholic+church+fresno+ca/@36.8763615,-119.847426,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x80944287fd52b535:0xd04fab0f77b1ee93!2m2!1d-119.777386!2d36.876382"
...
function(e) {
    ...
    function() {
        ...
        var isiPad = function() {
            ...
            countDownDate = new Date("Feb 23, 2019 13:00:00").getTime(),
